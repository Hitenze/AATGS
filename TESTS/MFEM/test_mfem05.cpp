/**
 * @file test_mfem05.cpp
 * @brief   MFEM test example 05
 * @details This problem is from the MFEM example 05, see below for the original description.
 */

//                                MFEM Example 5
//
// Compile with: make test_mfem05.ex
//
// Sample runs:  test_mfem05.ex -m ./data/square-disc.mesh
//               test_mfem05.ex -m ./data/star.mesh
//               test_mfem05.ex -m ./data/star.mesh -pa
//               test_mfem05.ex -m ./data/beam-tet.mesh
//               test_mfem05.ex -m ./data/beam-hex.mesh
//               test_mfem05.ex -m ./data/beam-hex.mesh -pa
//               test_mfem05.ex -m ./data/escher.mesh
//               test_mfem05.ex -m ./data/fichera.mesh
//
// Device sample runs:
//               test_mfem05.ex -m ./data/star.mesh -pa -d cuda
//               test_mfem05.ex -m ./data/star.mesh -pa -d raja-cuda
//               test_mfem05.ex -m ./data/star.mesh -pa -d raja-omp
//               test_mfem05.ex -m ./data/beam-hex.mesh -pa -d cuda
//
